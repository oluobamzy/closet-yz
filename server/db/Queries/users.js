...
const getUserByUsername =  (username) => {
  return db.query('SELECT * FROM users WHERE username = $1', [username]).then((data)=> data.rows).catch((e)=> console.log(e));
}
const addUser = (user) => { 
  const {
    username,
...
module.exports = { getAllUsers, getUserById, addUser, deleteUser, getUserByUsername };